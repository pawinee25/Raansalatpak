...
public class Spaghetti_Fragment extends Fragment {
    ...
    public Spaghetti_Fragment(Spaghetti_Fragment.SetOnOrderListener listener) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_spaghtti, container, false);
    }
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        mRecyclerView = (RecyclerView) view.findViewById(R.id.recyclerViewspaghtti);
    ...
    private void fetchProduct() {
        String sql = "SELECT * FROM `food` WHERE `Food_Type_ID` = 2";
    ...
    private class RecommentAdapter extends RecyclerView.Adapter<ProducrtHolder> {
        @NonNull
        @Override
        public Spaghetti_Fragment.ProducrtHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
